...
import com.bigtiger.kmvp.integration.ManifestParser
...
class AppDelegate(context: Context) : App, AppLifecycles {
    ...
    override fun onCreate(application: Application) {
        ...
        mAppComponent!!.extras().put(IntelligentCache.KEY_KEEP + ConfigModule::class.java.name, mModules!!)
    ...
    override fun getAppComponent(): AppComponent {
        Preconditions.checkNotNull(mAppComponent,
                ...
                AppComponent::class.java.name, this@AppDelegate::class.java.name, Application::class.java.name)
